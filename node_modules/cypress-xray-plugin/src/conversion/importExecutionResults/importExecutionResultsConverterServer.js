...
exports.ImportExecutionResultsConverterServer = void 0;
 ...
 */
class ImportExecutionResultsConverterServer extends importExecutionResultsConverter_1.ImportExecutionResultsConverter {
    getTest(attempt) {
        const json = {
    ...
    getXrayStatus(status) {
        switch (status) {
            case testStatus_1.Status.PASSED:
                return context_1.CONTEXT.config.xray.statusPassed || "PASS";
            case testStatus_1.Status.FAILED:
                return context_1.CONTEXT.config.xray.statusFailed || "FAIL";
            case testStatus_1.Status.PENDING:
                return context_1.CONTEXT.config.xray.statusPending || "TODO";
            case testStatus_1.Status.SKIPPED:
                return context_1.CONTEXT.config.xray.statusSkipped || "FAIL";
            default:
    ...
    getTestInfo(testResult) {
        const testInfo = {
            ...
            testType: context_1.CONTEXT.config.xray.testType,
        };
...
exports.ImportExecutionResultsConverterServer = ImportExecutionResultsConverterServer;
